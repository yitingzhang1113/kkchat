    ...
    >
      <el-container class="chat-window-container">
        ...
        <div style="display: flex; align-items: center; flex-direction: row;">
          ...
          <el-button @click="backToChat">Back</el-button>
        </el-header>
            ...
            <el-menu unique-opened>
              <el-sub-menu index="1">
                <template #title>
                  ...
                  <span class="manager-user-title">Users</span>
                </template>
              ...
              <el-sub-menu index="2">
                <template #title>
                  ...
                  <span class="manager-group-title">Groups</span>
                </template>
                ...
                <el-menu-item index="2-2" @click="showDeleteGroupTable">
                  ...
                  Delete/Dismiss Group</el-menu-item
                >
              </el-sub-menu>
            </el-menu>
          </el-aside>
