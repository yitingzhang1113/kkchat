      ...
      <el-container class="chat-window-container">
        ...
        <el-container class="chat-container">
          ...
          <el-footer>
            ...
            <div class="chat-send">
              <el-button class="send-btn">Send</el-button>
            </div>
          </el-footer>
        </el-container>
      </el-container>
...
export default {
  ...
  ElMessage("Please choose a join mode.");
        return;
      }
      data.isCreateGroupModalVisible = false;
      handleCreateGroup();
  ...
  ElMessage.error("Please enter a user/group ID to apply.");
        return;
      }
      ...
      try {
        ...
        if (rsp.data.code == 200) {
          if (rsp.data.message == "申请成功") {
            data.isApplyContactModalVisible = false;
            ElMessage.success("Application sent.");
            return;
          } else {
