  ...
  <div style="height: 100%; width: 100%" v-if="isVisible">
    ...
    >
      ...
      <el-table-column
        ...
        show-overflow-tooltip
      />
      <el-table-column prop="is_admin" label="Admin" width="80" >
      ...
      <el-table-column label="Deletion status" width="90">
        <template #default="scope">
      ...
      <el-table-column label="Disabled" width="90">
        <template #default="scope">
