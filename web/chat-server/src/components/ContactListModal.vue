              ...
              >
                ...
                >
                  <el-input
                    ...
                    placeholder="Enter the user/group ID"
                  />
                </el-form-item>
                <el-form-item prop="message" label="Request message">
                  <el-input
                    v-model="applyContactReq.message"
                    placeholder="Optional. A note can help approval."
                    type="textarea"
                    show-word-limit
                    maxlength="100"
                ...
                >
                  ...
                  <el-form-item
                    ...
                    :rules="[
                      {
                        required: true,
                        message: 'Please select a join method',
                        trigger: 'change',
                      },
                    ]"
                  >
    ...
    <div class="contactlist-body">
      <div class="contactlist-user">
        ...
        >
          <el-sub-menu index="1">
            <template #title>
              <span class="contactlist-user-title">Contacts</span>
            </template>
          </el-sub-menu>
          <el-menu-item
        ...
        >
          <el-sub-menu index="1">
            <template #title>
              <span class="contactlist-user-title">Groups I created</span>
            </template>
          </el-sub-menu>
          <el-menu-item
        ...
        >
          <el-sub-menu index="1">
            <template #title>
              <span class="contactlist-user-title">Groups I joined</span>
            </template>
          </el-sub-menu>
          <el-menu-item
...
export default {
  ...
  console.log("File before upload====>", file);
      ...
      if (data.fileList.length > 1) {
        ElMessage.error("Only one avatar image allowed");
        return false;
      }
      const isLt50M = file.size / 1024 / 1024 < 50;
      if (!isLt50M) {
        ElMessage.error("Avatar image must be 50MB or less!");
        return false;
      }
    };
    ...
    const closeCreateGroupModal = () => {
      if (data.createGroupReq.name == "") {
        ElMessage("Please enter a group name");
        return;
      }
      if (data.createGroupReq.add_mode == null) {
        ElMessage("Please select a join method");
        return;
      }
      data.isCreateGroupModalVisible = false;
      handleCreateGroup();
    ...
    const closeApplyContactModal = () => {
      if (data.applyContactReq.contact_id == "") {
        ElMessage.error("Please enter the user/group ID");
        return;
      }
    ...
    const handleNewContactList = async () => {
      try {
        ...
        if (data.newContactList == null) {
          ElMessage.warning("No new friend requests");
          return;
        }
